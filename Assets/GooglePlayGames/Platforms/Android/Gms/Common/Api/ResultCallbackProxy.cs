...
namespace Com.Google.Android.Gms.Common.Api
{
        ...
        where R : Result
    {
        ...
        public void onResult(AndroidJavaObject arg_Result_1)
        {
            ...
            System.Reflection.ConstructorInfo c = typeof(R).GetConstructor(new System.Type[] { ptr.GetType() });
            if (c != null)
            {
            ...
            else
            {
                ...
                System.Reflection.ConstructorInfo c0 = typeof(R).GetConstructor(new System.Type[0]);
